<?php
	...
	class hmrc_rti_eps extends hmrc_rti { // Employer Payment Summary - Send an EPS instead of an FPS if you've not paid any employees in a tax month.
		...
		public function request_body_get_xml() {
			...
			} else if ($this->details['year'] == 2025) {
				$namespace = 'http://www.govtalk.gov.uk/taxation/PAYE/RTI/EmployerPaymentSummary/25-26/1';
			} else if ($this->details['year'] == 2026) {
				$namespace = 'http://www.govtalk.gov.uk/taxation/PAYE/RTI/EmployerPaymentSummary/26-27/1';
			} else {

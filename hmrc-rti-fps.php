	...
	class hmrc_rti_fps extends hmrc_rti { // Full Payment Submission
		...
		public function request_body_get_xml() {
			...
			if ($this->details['year'] == 2013) {
				...
				$namespace = 'http://www.govtalk.gov.uk/taxation/PAYE/RTI/FullPaymentSubmission/25-26/1';
			} else if ($this->details['year'] == 2026) {
				$namespace = 'http://www.govtalk.gov.uk/taxation/PAYE/RTI/FullPaymentSubmission/26-27/1';
			} else {
